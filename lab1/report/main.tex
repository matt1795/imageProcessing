...
\fancypagestyle{neilReport}{ 
    ...
    \fancyhead[R]{Lab 2: Point Processing}
...
\begin{center}
    ...
    {\fontsize{28pt}{12pt}\fontfamily{qpl}\selectfont\bfseries Lab 2}
    
    \vspace{12pt}
    
    {\fontsize{26pt}{12pt}\fontfamily{qpl}\selectfont\bfseries\itshape Point Processing}
