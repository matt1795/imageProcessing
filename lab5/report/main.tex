...
\fancypagestyle{neilReport}{ 
    ...
    \fancyhead[R]{\footnotesize Lab 5: Image Sub-Sampling and Aliasing}
...
\begin{center}
    ...
    {\fontsize{28pt}{12pt}\fontfamily{qpl}\selectfont\bfseries Lab 5}
    
    \vspace{12pt}
    
    {\fontsize{26pt}{12pt}\fontfamily{qpl}\selectfont\bfseries\itshape Image Sub-Sampling and Aliasing}
