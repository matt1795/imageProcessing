...
\fancypagestyle{neilReport}{ 
    ...
    \fancyhead[R]{\footnotesize Assignment 4}
    \fancyfoot[C]{\footnotesize\thepage\hspace{1ex}of\hspace{1ex}\pageref{LastPage}}
}
...
\begin{center}
    ...
    {\fontsize{28pt}{12pt}\fontfamily{qpl}\selectfont\bfseries Assignment 4}
