...
\fancypagestyle{neilReport}{ 
    ...
    \fancyhead[R]{\footnotesize Lab 3: Histogram Processing}
...
\begin{center}
    ...
    {\fontsize{28pt}{12pt}\fontfamily{qpl}\selectfont\bfseries Lab 3}
    
    \vspace{12pt}
    
    {\fontsize{26pt}{12pt}\fontfamily{qpl}\selectfont\bfseries\itshape Histogram
    Processing}
