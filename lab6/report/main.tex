...
\fancypagestyle{neilReport}{ 
    ...
    \fancyhead[R]{\footnotesize Lab 6: Image Quantization}
...
\begin{center}
    ...
    {\fontsize{28pt}{12pt}\fontfamily{qpl}\selectfont\bfseries Lab 6}
    
    \vspace{12pt}
    
    {\fontsize{26pt}{12pt}\fontfamily{qpl}\selectfont\bfseries\itshape Image
    Quantization}
