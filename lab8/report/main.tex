...
\fancypagestyle{neilReport}{ 
    ...
    \fancyhead[R]{\footnotesize Lab 8: DCT Transform}
...
\begin{center}
    ...
    {\fontsize{28pt}{12pt}\fontfamily{qpl}\selectfont\bfseries Lab 8}
    
    \vspace{12pt}
    
    {\fontsize{26pt}{12pt}\fontfamily{qpl}\selectfont\bfseries\itshape DCT
    Transform}
